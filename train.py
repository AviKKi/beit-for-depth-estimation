...
def parse_args():
    ...
    parser.add_argument(
        "--model_ckpt",
        default="microsoft/beit-base-finetuned-ade-640-640",
        type=str,
        choices=["microsoft/beit-base-finetuned-ade-640-640", "vinvino02/glpn-kitti"],
        help="Name of the Beit model checkpoint to fine-tune.",
    )
    parser.add_argument(
...
def main(args):
    ...
    commit_message = f"avikki/beit-for-depth-estimation"
